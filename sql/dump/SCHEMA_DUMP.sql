...
DROP FUNCTION IF EXISTS "public"."groups_get_tree_for_user"("target_user_id" "uuid");
...
--
-- Name: groups_get_tree_for_user("uuid"); Type: FUNCTION; Schema: public; Owner: supabase_admin
--

CREATE FUNCTION "public"."groups_get_tree_for_user"("target_user_id" "uuid") RETURNS TABLE("id" "uuid", "parent_id" "uuid", "name" "text", "description" "text", "level" numeric)
    LANGUAGE "sql"
    AS $$
...
ALTER FUNCTION "public"."groups_get_tree_for_user"("target_user_id" "uuid") OWNER TO "supabase_admin";
...
--
-- Name: FUNCTION "groups_get_tree_for_user"("target_user_id" "uuid"); Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON FUNCTION "public"."groups_get_tree_for_user"("target_user_id" "uuid") TO "postgres";
GRANT ALL ON FUNCTION "public"."groups_get_tree_for_user"("target_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."groups_get_tree_for_user"("target_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."groups_get_tree_for_user"("target_user_id" "uuid") TO "service_role";
